...
<template>
	<view>
		...
		<uni-popup ref="popup" type="card">
			<camp-card :cardInfo="popupCard" :comment="comment" showComment="true"></camp-card>
		</uni-popup>
		<!-- 新建文章弹窗 -->
		<uni-popup ref="create" type="card">
			<camp-create @close="closeSubmission"></camp-create>
		</uni-popup>
		<!-- 新建文章按钮 -->
		<button class="button-create" hover-class="button-create-hover" @click="createPaper">
			<image src="../../static/login/铅笔.png" style="width: 80upx; height: 80upx;"></image>
		</button>
	</view>
</template>

<script>
	import CampCreate from '@/components/camp-create/camp-create.vue'
